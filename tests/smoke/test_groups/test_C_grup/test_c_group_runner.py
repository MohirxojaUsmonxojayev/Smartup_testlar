...
def run_c_group_chain(group_page, code, save_data, load_data):
    ...
    with progress_step(
        ...
        run_c_group_create_action(group_page, code, login=False)
    with progress_step(
        group="C group",
        runner=C_GROUP_RUNNER_TEST,
